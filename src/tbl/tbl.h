...
int tbl_ctor(tbl *const restrict me, size_t cap, size_t (*hash_key)(const void *const restrict), int (*key_dtor)(void *const restrict), int (*value_dtor)(void *const restrict));
